...
public class GhostsPacmanFarEuclidTransition implements Transition {

	GHOST ghost;
	public GhostsPacmanFarEuclidTransition(GHOST ghost) {
		super();
		this.ghost = ghost;
	}
	...
	public boolean evaluate(Input in) {
		...
		return input.farFromPacmanEuclid(ghost);
	}
